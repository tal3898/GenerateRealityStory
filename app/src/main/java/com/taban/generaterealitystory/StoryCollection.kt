...
class StoryCollection {
    ...
    var stories = CopyOnWriteArrayList(Arrays.asList(
        ...
        "I am black which changed color to white. Whole my life I suffered from racism. People avoided me, accused me for things which happened in my neighborhood. So I decided to make a surgery to change color to white, and never regret it. People now treat me nicely, greet me with 'good morning'. I am here to give a message to the black people. Never give up, and change color ! ",
        "I am trans-transgender. I changed my sex, and after a while changed it back to my original sex. My parents took it very hard that I changed my sex back to the original. They were the hardest people to tell that I want to change my sex to my original sex.",
